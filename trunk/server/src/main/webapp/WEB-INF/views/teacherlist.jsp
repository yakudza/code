...
<br/>
<center>
	<b><font size="+3" color="orange">List Teachers</font></b><br/>
</center>
<br/>
<table id='content'>
<tr>
...
<tr>
	...
	<td>
		<form method="get"  action="<c:url value="/sublist/${user.userId}"/>">
			<input class="button" type="submit" value="List subjects"/>
		</form>
	</td>
	<td>
		<form:form action="${pageContext.request.contextPath}/teacherlist${user.userId}">
