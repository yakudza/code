<%-- 
    Document   : adminlist
    Created on : 06.01.2013, 00:03:19
...
<br/>
<center>
	<b><font size="+3" color="orange">List of Admins</font></b><br/>
</center>
<br/>
<table id='content'>
<tr>
...
<tr>
	...
	<td>
		<form:form action="${pageContext.request.contextPath}/adminlist${user.userId}">
